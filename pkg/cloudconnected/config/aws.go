...
type CloudFormationConfig struct {
	...
	DeploymentRoleTemplateURL     string `yaml:"DeploymentRoleTemplateURL"     validate:"url"      default:"https://panther-public-cloudformation-templates.s3.us-west-2.amazonaws.com/panther-deployment-role/latest/template.yml"`
